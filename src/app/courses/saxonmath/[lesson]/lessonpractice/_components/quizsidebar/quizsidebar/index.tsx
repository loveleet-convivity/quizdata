...
export default function QuizSidebar({ btn, data, setter, children }: any) {
  ...
  return (
    ...
    >
      ...
      <div
        className="grid grid-cols-3 gap-[0.5rem] max-md:pl-[2rem] px-[1rem] pb-3 border-r overflow-y-scroll scrollbar-w-6"
        style={
          isMobile
      ...
      >
        <QuestionList data={data} setter={setter} />
      </div>
    </div>
  );
}
